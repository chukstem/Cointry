...
class BuyScreen extends StatefulWidget {
  CryptoModel obj;
  CryptoModel fiat;
  BuyScreen({required this.obj, required this.fiat});
  ...
  cachedList() async {
    setState(() {
      if(widget.obj.type.toLowerCase()=="fiat"){
        rate=widget.fiat.networkModel.first.currency_symbol.toUpperCase()!="HTG"? double.parse(widget.fiat.networkModel.first.sell_price.replaceAll(",", ""))/double.parse(widget.obj.networkModel.first.sell_price.replaceAll(",", "")) : double.parse(widget.fiat.networkModel.first.buy_price.replaceAll(",", ""))/double.parse(widget.obj.networkModel.first.buy_price.replaceAll(",", ""));
      } else {
        rate = double.parse(widget.obj.networkModel.first.buy_price.replaceAll(",", "")) * double.parse(widget.fiat.networkModel.first.buy_price.replaceAll(",", ""));
      }
    });
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(widget.fiat.networkModel.first.currency_symbol+" to "+widget.obj.networkModel[0].currency_symbol, maxLines: 2, style: TextStyle(color: kSecondary, fontSize: 25, fontWeight: FontWeight.bold),),
                  Container(
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                        ...
                        child: Center(child: Text("Available ${widget.fiat.networkModel.first.currency_symbol}: ${widget.fiat.balance}", style: TextStyle(color: kSecondary),),)
                    ),
                  ),
                ],
              ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          setState(() {
                              var text = double.parse(widget.fiat.balance.replaceAll(",", ""))*25/100;
                              CryptoAmountController.text = format(text.toString().replaceAll(",", ""), "2");
                              isFiat=true;
                          });
                        },
                        child: Container(
                      ...
                      InkWell(
                        onTap: (){
                          setState(() {
                              var text = double.parse(widget.fiat.balance.replaceAll(",", ""))/2;
                              CryptoAmountController.text = format(text.toString().replaceAll(",", ""), "2");
                              isFiat=true;
                          });
                        },
                      ...
                      InkWell(
                        onTap: (){
                          setState(() {
                              var text = double.parse(widget.fiat.balance.replaceAll(",", ""))*75/100;
                              CryptoAmountController.text = format(text.toString().replaceAll(",", ""), "2");
                              isFiat=true;
                          });
                        },
                      ...
                      InkWell(
                        onTap: (){
                          setState(() {
                              CryptoAmountController.text = widget.fiat.balance;
                              isFiat=true;
                          });
                        },
                        child: Container(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    width: MediaQuery.of(context).size.width*0.45,
                                    child: Text(
                                      format("${(double.parse(amount.replaceAll(",", ""))*(double.parse(widget.obj.networkModel.first.buy_fee.replaceAll(",", ""))/100))+double.parse(widget.obj.networkModel[0].buy_fee_fixed.replaceAll(",", ""))}", widget.obj.networkModel[0].decimals)+" ${widget.obj.networkModel.first.currency_symbol}",
                                      textAlign: TextAlign.end,
                                      style: TextStyle(
                                        fontSize: 16.0,
                                        color: Colors.black,
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    width: MediaQuery.of(context).size.width*0.45,
                                    child: Text(isFiat? CryptoAmountController.text.replaceAll(",", "")+" ${widget.fiat.networkModel.first.currency_symbol}" : format("${double.parse(amount.replaceAll(",", ""))*rate}", '2')+" ${widget.fiat.networkModel.first.currency_symbol}",
                                      textAlign: TextAlign.end,
                                      style: TextStyle(
                                        fontSize: 16.0,
                                        color: Colors.black,
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            " ${widget.obj.networkModel.first.currency_symbol}", json.encode({
                            'username': '$username',
                            'isFiat': '$isFiat',
                            ...
                            'swap_id': Uuid().v4(),
                            'pin': '$pin'}), "/buy-crypto", Language.buy, setState);
                          },),
                      ],
                    )),
              );
