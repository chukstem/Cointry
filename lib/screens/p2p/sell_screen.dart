...
class P2PSellScreen extends StatefulWidget {
  P2PModel obj;
  P2PSellScreen({required this.obj});

  @override
  _P2PSellScreenState createState() => _P2PSellScreenState();
}
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text("Sell "+widget.obj.currency_symbol, maxLines: 2, style: TextStyle(color: Colors.black, fontSize: 25, fontWeight: FontWeight.bold),),
                ],
              ),
            ),
            Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Please read the advertiser's terms before placing an order. Failure to comply might result in failed transaction and financial loss.",
                      style: TextStyle(
                          fontSize: 16,
                          color: Colors.black
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              "Rate: "+widget.obj.fiat_symbol + widget.obj.amountRate,
                              style: TextStyle(
                                  fontSize: 16,
                          ...
                          Container(
                            ...
                            child: Text(
                              "Limit: "+widget.obj.fiat_symbol + widget.obj.amountMin +
                              ...
                              child: ElevatedButton(
                                onPressed: (){
                                  if(!isChecked){
                                    ...
                                    Toast.show(Language.select_beneficiary, duration: Toast.lengthLong, gravity: Toast.bottom);
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            ...
                            Pin(context, format("${double.parse(amount.replaceAll(",", ""))/double.parse(widget.obj.amountRate.replaceAll(",", ""))}", widget.obj.currency_decimals)+" ${widget.obj.currency_symbol}", json.encode({
                              ...
                              'pin': pin}), "/trade/initiate/"+widget.obj.id, Language.sell, setState);
                          },),
                      ],
                    )),
              );
